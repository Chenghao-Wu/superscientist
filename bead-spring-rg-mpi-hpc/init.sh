...
# MPI+KOKKOS command: mpirun -np 2 /gpfs/home/che/zhenghaowu/lammps-install/bin/lmp -k on g 1 -sf kk
# See workflow-state.json stage-2/stage-3 parameters: lammps_binary, lammps_flags, mpi_command.
